...
class magma_foreach_face_node : public magma_loop_node {
  ...
  public:
    MAGMA_REQUIRED_METHODS( magma_foreach_face_node );
...
class magma_foreach_face_inputs_node : public magma_loop_inputs_node {
  public:
    MAGMA_REQUIRED_METHODS( magma_foreach_face_inputs_node );

    magma_foreach_face_inputs_node();
};

class magma_foreach_face_outputs_node : public magma_loop_outputs_node {
  public:
    MAGMA_REQUIRED_METHODS( magma_foreach_face_outputs_node );

    magma_foreach_face_outputs_node();
};
