...
class magma_foreach_containing_face_node : public magma_loop_node {
    std::pair<magma_interface::magma_id, int> m_geomInput, m_objIndexInput, m_vertIndexInput;
    variant_t m_geomDefault, m_objIndexDefault, m_vertIndexDefault;
  ...
  public:
    MAGMA_REQUIRED_METHODS( magma_foreach_containing_face_node );
    ...
    magma_foreach_containing_face_node();
...
class magma_foreach_containing_face_inputs_node : public magma_loop_inputs_node {
  public:
    MAGMA_REQUIRED_METHODS( magma_foreach_containing_face_inputs_node );

    magma_foreach_containing_face_inputs_node();
};

class magma_foreach_containing_face_outputs_node : public magma_loop_outputs_node {
  public:
    MAGMA_REQUIRED_METHODS( magma_foreach_containing_face_outputs_node );

    magma_foreach_containing_face_outputs_node();
};
