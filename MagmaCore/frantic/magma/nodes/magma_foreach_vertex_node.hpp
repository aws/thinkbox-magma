...
class magma_foreach_vertex_node : public magma_loop_node {
    ...
    MAGMA_PROPERTY( visibleOnly, bool );

  protected:
    virtual void do_clone( magma_node_base& dest, clone_callback& cb ) const;

  public:
    MAGMA_REQUIRED_METHODS( magma_foreach_vertex_node );
...
class magma_foreach_vertex_inputs_node : public magma_loop_inputs_node {
  public:
    MAGMA_REQUIRED_METHODS( magma_foreach_vertex_inputs_node );

    magma_foreach_vertex_inputs_node();

    virtual void get_output_description( int i, frantic::tstring& outDescription ) const;
};

class magma_foreach_vertex_outputs_node : public magma_loop_outputs_node {
  public:
    MAGMA_REQUIRED_METHODS( magma_foreach_vertex_outputs_node );

    magma_foreach_vertex_outputs_node();
};
